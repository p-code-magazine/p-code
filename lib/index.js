  ...
  execute(t) {
    if (t != this.prevChar) {
      if (isNaN(t)) {
        ...
        if (!isNaN(this.freq)) {
          //! NOTE: Clamp frequency, because outside of "0 to 3.402823669209385e+38(32bit)" values crash Tone.js
          this.freq = Math.min(Math.max(0, this.freq), 3.402823669209385e+38);
          // --
